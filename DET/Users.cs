...
namespace DET
{
    public class Users
    {
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(servicePrincipalName=*))";
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(userAccountControl:1.2.840.113556.1.4.803:=65536))";
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(userAccountControl:1.2.840.113556.1.4.803:=32))";
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(userAccountControl:1.2.840.113556.1.4.803:=1048576))";
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(msds-allowedtodelegateto=*))";
        ...
        {
            var ldap = new LDAP(_searcher);
            var filter = "(&(sAMAccountType=805306368)(adminCount=1))";
